...
print(len(nonsymmetrical_11_8ghz_reverse))
import matplotlib.pyplot as plt

# plt.plot(z_10_ghz, c='r', linewidth = 5)
# plt.plot(z_10_ghz_reverse, c='b', linewidth = 5)
plt.plot(nonsymmetrical_10_ghz_reverse, c='r', linewidth = 5)
# plt.plot(np.flip(z_8_2_ghz), c='r', linewidth = 5, linestyle=':')
plt.plot(nonsymmetrical_8_2_ghz_reverse, c='b', linewidth = 5)
